    ...
    <body>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<th> <td>itemID</td> <td>name</td> <td> genre </td> <td>stock</td> <td>cost</td> <td>desc</td> <td>phot</td> </th>';
        ...
        <form method="post" style="border: 5px solid grey; text-align:center; padding: 10px;">
            ...
            genre: 
            <input type="radio" id="writing" name="genre" value="writing">
            <label for="writing">writing</label>
            <input type="radio" id="paper" name="genre" value="paper">
            <label for="paper">paper</label>
            <input type="radio" id="arts" name="genre" value="arts">
            <label for="arts">arts</label>
            <input type="radio" id="organize" name="genre" value="organize">
            ...
            <label for="phot_path" align = "right">photo:</label>
            <input type="file" id="phot_path" name="phot_path">
            <br>
        ...
        <?php
            ...
            $phot_path= $_FILES['phot_path']['name'];
            $phot_path_tmp = $_FILES['phot_path']['tmp_name'];
            
            move_uploaded_file($phot_path_tmp,"product_images/$phot_path");
